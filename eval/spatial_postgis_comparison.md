...
## Datasets (app.id BPS 2020 admin boundaries)
...
# PostGIS baseline
docker run -d --name skj-postgis -e POSTGRES_PASSWORD=changeme -e POSTGRES_DB=gis \
  -p 5433:5432 postgis/postgis:16-3.4
ogr2ogr -f PostgreSQL "PG:host=localhost port=5433 dbname=gis user=postgres password=changeme" \
