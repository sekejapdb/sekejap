...
cd "$root/src"
cargo test --offline --release -p sekejap-kernel --features sqlite-balance,compact-cells --lib --test resource_limits -- --test-threads=1 > "$root/artifacts/final-tests.log" 2>&1
