"""Audit persistent-freelist trials with independent three-engine checks."""
...
specs=([(f'batch-{batch}-r{rep}',batch,n,cycles,'none') for rep in (1,2)
    for batch,n,cycles in ((1,1000,2),(100,10000,3))]+[
...
assert len(reports)==(18 if pi else 24)
...
name='REUSE_PI_RESULTS.json' if pi else 'REUSE_RESULTS.json'
