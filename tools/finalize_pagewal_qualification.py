...
decision={'decision':'Retain page-WAL v2 isolated; not promoted or shipped','source_archive_sha256':summary['frozen_provenance']['artifacts']['source.tar.gz'],
    ...
    'new_known_failure_regression':{'path':'core/engine/tests/accepted_control_scan_regression.rs','sha256':sha(r/'core/engine/tests/accepted_control_scan_regression.rs'),'default':'ignored with explicit reason; explicit run reproduces failure'},
...
'''
doc.write_text(text)
for name in ['README.md','CONTRACT.md','docs/core/FOUNDATION_TEST_STANDARD.md','docs/FOUNDATION_GATES.json',
...
shutil.copy2('/tmp/e4-pagewal-qualify/bench/src/bin/pagewal_cap.rs',b/'short-cap.rs')
shutil.copy2(r/'core/engine/tests/accepted_control_scan_regression.rs',b/'accepted_control_scan_regression.rs')
...
shutil.copy2('/tmp/e4-pagewal-audit/dist/src/cli/main.rs',audit_source/'main.rs')
