...
//!
//! `docs/lang/QL_CONTRACT.md` §4.7 says `count(*)`, `count(col)`, `sum`, `min`,
...
fn count_all_is_one_group_over_the_key_order_driver() {
    ...
    assert_eq!(plan.query.driver, sekejap_core::collections::QueryDriver::Keys);
    let page = prepared
    ...
    let mut prepared = f
        ...
        .prepare_aggregate(AggregateRequest {
            ...
            order: GroupOrder::Accumulator {
                at: 0,
                direction: sekejap_core::collections::SortDirection::Descending,
            },
            driver: CandidateDriver::Auto,
            total_limit: Some(3),
        })
