...
fn seed_people(db: &mut Database) -> sekejap_core::collections::CollectionId {
    let people = db
        .create_collection(
            "people",
            vec![
...
fn assert_whole(db: &Database, id: sekejap_core::collections::IndexId) {
...
/// build (`bench/src/bin/phase2_multimodel_bench.rs:909-911`, mirrored by every
