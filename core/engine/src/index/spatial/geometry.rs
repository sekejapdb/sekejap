...
//! PostGIS. See `docs/core/SPATIAL_FUNCTIONS.md` for the full decision table
...
/// from the outer still subtracts identically (`docs/core/SPATIAL_FUNCTIONS.md`).
...
fn point_in_ring_geodesic(lon: f64, lat: f64, ring: &[[f64; 2]], boundary_inclusive: bool) -> bool {
    ...
    if let Some(geodesic_side) = on_chord {
        ...
        // Both verified against PostGIS 3.6 (`docs/core/SPATIAL_FUNCTIONS.md`).
...
/// `geography` overload (see `docs/core/SPATIAL_FUNCTIONS.md`); this is the one
