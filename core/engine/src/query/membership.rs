...
impl PreparedQuery<'_> {
    ...
    pub(super) fn ensure_membership_sets<C: FnMut() -> bool>(
        ...
        // resource named, not a plan. `docs/lang/QL_CONTRACT.md` §3 says so
...
// ── boolean set algebra (docs/lang/QL_CONTRACT.md §3) ──────────────────────────
...
// ── per-hop node predicates (docs/core/GRAPH_CONTRACT.md §4.3) ─────────────────
