...
//! the driver choice. See docs/lang/QL_CONTRACT.md,
...
pub(super) enum CompiledFilter {
    ...
    Graph {
        ...
        position: usize,
        /// The node predicates of `docs/core/GRAPH_CONTRACT.md` §4.3, compiled
    ...
    /// into set algebra (`docs/lang/QL_CONTRACT.md` §3).
    ///
...
/// a LEAF as it goes (`docs/lang/QL_CONTRACT.md` §3).
///
...
impl Database {
    ...
    pub fn prepare_query<'db>(
        ...
        // projection or an `@edge` ranking (`docs/core/GRAPH_CONTRACT.md` §4.2)?
        ...
        // `docs/core/GRAPH_CONTRACT.md` §4.2: the reaching edge is carried by the
