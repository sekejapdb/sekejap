...
//! `DriverCursor` keyspace helpers. See docs/lang/QL_CONTRACT.md,
//! "Execution pipeline", and docs/core/GRAPH_CONTRACT.md section 4.
use super::*;
...
pub(super) enum DriverPlan {
    ...
    /// (`docs/lang/QL_CONTRACT.md` §4.4) refined against the row by
...
/// each of them, in the same order (`docs/core/GRAPH_CONTRACT.md` §4.2).
...
///
/// `docs/core/GRAPH_CONTRACT.md` §4.2 and §4.3 are the code's behaviour here:
...
pub(super) struct Candidate {
    ...
    /// (`docs/core/GRAPH_CONTRACT.md` §4.2), shared with the traversal's answer
...
/// atomic (`docs/lang/QL_CONTRACT.md` §4.4), not a T3 refusal, and the row's
