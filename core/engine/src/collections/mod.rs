...
//! Keys and immutable layouts are documented in docs/core/COLLECTIONS.md; the
//! storage path, its limits and its deviations in docs/core/V2_COLLECTION_INTEGRATION.md.
...
pub enum Error {
    ...
    /// `docs/core/GRAPH_CONTRACT.md` §4.3) reports the resource machine-readably
...
pub struct CollectionInfo {
    ...
    /// `docs/lang/QL_CONTRACT.md` §5 deviation 8 -- so the `Kind` alone cannot say
