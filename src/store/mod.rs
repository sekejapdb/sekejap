//! The storage layer: the page-WAL store, the recovery reader, the dense row
//! codec and the scalar index key codec. This file is the backend itself --
...
pub mod pagewal;
pub mod recovery;
pub(crate) mod dense_v3;
pub(crate) mod scalar_key;

use self::pagewal::{PageWalStore, HINT_FILE_BYTES, READER_SLOTS};
use kernel::{
