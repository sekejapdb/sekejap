...
| **Kotlin/Java** | [Maven Central](https://central.sonatype.com) | Gradle `implementation("life.sekejap:sekejap:0.17.0")` | Publish via the Sonatype **Central Portal**. groupId **`life.sekejap`** (matches `group` in the Gradle build files) |
