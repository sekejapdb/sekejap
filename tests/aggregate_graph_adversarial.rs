...
struct Fixture {
    ...
    likes: e4_prototype::collections::EdgeTypeId,
    alt: GraphContextId,
    index: Indexes,
...
impl Fixture {
    ...
    fn edge_type_id(&self, ty: Option<u64>) -> Option<e4_prototype::collections::EdgeTypeId> {
        match ty {
            None => None,
    ...
    fn engine(
        &self,
        q: &GQuestion,
    ) -> Result<Vec<(EntityId, usize, Option<Value>)>, e4_prototype::collections::Error> {
...
fn work_of(
    ...
    edge_type: Option<e4_prototype::collections::EdgeTypeId>,
