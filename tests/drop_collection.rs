...
/// `docs/COLLECTIONS.md`'s order-preserving integer: a width tag then the
...
/// Every index-entry tag of every family, from `docs/SOURCE_LAYOUT.md`'s
...
fn a_published_dropping_mark_refuses_every_reader_and_writer() {
    ...
    let request = |c| QueryRequest {
        ...
        total_limit: None,
        driver: e4_prototype::collections::CandidateDriver::Auto,
    };
