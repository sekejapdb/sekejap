//! `docs/QL_CONTRACT.md` §4.1 (string) and §4.2 (date/time) under test, with
...
//!
//! The fixture is this file's own, in the style of `tests/sqlslice/fixture.rs`
...
use e4_prototype::sql::{SqlError, SqlResult, SqlRow, SqlValue, Tier, MULTI_RANGE_REASON};
use kernel::{
    io::IoMode,
