//! Every construct `docs/lang/QL_CONTRACT.md` places in Tier 2 or Tier 3 must be
//! REFUSED by name, with that tier and with a reason that names the atomic.
//!
//! This is the eighth law of `docs/core/FOUNDATION_TEST_STANDARD.md` under test: a
...
use sekejap_lang::{refusals, Param, SqlError, Tier};
...
/// membership-set algebra (`docs/lang/QL_CONTRACT.md` §3): each is a complement,
...
// landed and are asserted in lang/tests/sql_tier1.rs; what stays refused here is
