...
[`docs/V2_COLLECTION_INTEGRATION.md`](V2_COLLECTION_INTEGRATION.md) (exact
...
[`docs/V2_COMPAT_FIXTURES.md`](V2_COMPAT_FIXTURES.md). No index-compatibility
proof exists yet.
...
fully specified in
[`docs/V2_BENCHMARK_PROTOCOL.md`](V2_BENCHMARK_PROTOCOL.md) and are
