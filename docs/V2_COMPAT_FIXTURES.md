...
`src/bin/v2_compat_fixture.rs` is a bounded, file-tools-produced helper for
gathering real older/newer-binary evidence toward `docs/FORMAT_FREEZE.md`
...
- Not proof of the release-frozen format from `docs/FORMAT_FREEZE.md`: the
