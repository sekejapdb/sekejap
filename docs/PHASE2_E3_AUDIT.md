...
E3 tags in `kernel/src/keys.rs`: catalog00, node01, label02, edge03, reverse04, vector05, external06, perspective-edge08/09, property0A, vector-code0B, text0C, text-norm0D, text-meta0E, spatial0F, geometry10, nav11, SQL metadata12; further scalar/search keyspaces follow. Do not copy tag values into E4 without checking its reserved vocabulary.
