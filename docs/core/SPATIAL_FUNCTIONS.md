...
| C4 | Unclosed ring. E4 closes implicitly (`core/kernel/src/spatial.rs`); PostGIS `ST_IsValid` is false and measures three sides. | documented | `documented_unclosed_ring_e4_closes_postgis_does_not` |
